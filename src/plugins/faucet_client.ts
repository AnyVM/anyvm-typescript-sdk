 ...
 */
export class FaucetClient extends MoveupClient {
  faucetRequester: AxiosHttpRequest;

  /**
   * Establishes a connection to Moveup node
   * @param nodeUrl A url of the Moveup Node API endpoint
   ...
   * @param address Hex-encoded 20 bytes Moveup account address wich mints tokens
