...
/**
 * Provides methods for retrieving data from Moveup Indexer.
 * For more detailed Queries specification see
 * {@link https://cloud.hasura.io/public/graphiql?endpoint=https://indexer.mainnet.Moveuplabs.com/v1/graphql}
 */
export class IndexerClient {
  endpoint: string;

  /**
   * @param endpoint URL of the Moveup Indexer API endpoint.
   */
  ...
  /**
   * Builds a axios client call to fetch data from Moveup Indexer.
   *
  ...
  /**
   * Queries an Moveup account's NFTs by owner address
   *
   * @param ownerAddress Hex-encoded 20 byte Moveup account address
