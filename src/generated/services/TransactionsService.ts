...
export class TransactionsService {
     ...
     * Make sure to use the `application/x.moveup.signed_transaction+bcs` Content-Type.
     * @param requestBody
     ...
     * 1. Hash message bytes: "RawTransaction" bytes + BCS bytes of [Transaction](https://moveup-labs.github.io/moveup-core/moveup_types/transaction/enum.Transaction.html).
