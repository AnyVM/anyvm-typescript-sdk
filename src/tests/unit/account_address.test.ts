...
import { AccountAddress } from "../../moveup_types";

const ADDRESS_LONG = "000000000000000000000000000000000a550c18";
...
describe("AccountAddress", () => {
  ...
  it("throws exception when initiating from a long hex string", async () => {
    ...
    }).toThrow("Hex string is too long. Address's length is 20 bytes.");
  });
