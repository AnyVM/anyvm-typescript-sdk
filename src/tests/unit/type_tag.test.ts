import { StructTag, TypeTagParser, TypeTagParserError, TypeTagStruct } from "../../moveup_types/type_tag";

const expectedTypeTag = {
  string: "0x0000000000000000000000000000000000000001::eth::ETH",
...
describe("TypeTagParser", () => {
  ...
  test("make sure parseTypeTag works with nested type tag", () => {
    const typeTag = "0x1::eth::ETH<0x1::eth::ETH, 0x1::eth::ETH>";
