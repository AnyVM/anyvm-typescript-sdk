  ...
  test(
    ...
    async () => {
      ...
      abi.set("0x1::some_modules::SomeName", {
        ...
        is_view: false,
        generic_type_params: [],
        params: ["&signer", "0x1::string::String", "0x1::object::Object<T>", "vector<u8>", "0x1::fixed_point32::FixedPoint32", "0x1::fixed_point64::FixedPoint64", "0x1::option::Option<u8>"],
        return: [],
        visibility: "public",
      });
      ...
      expect((rawTxn.payload as TransactionPayloadEntryFunction).value.args).toHaveLength(6);
  ...
  test(
    ...
    async () => {
      ...
      const rawTxn = await builder.build(
        ...
        ["0x1::type::SomeType"],
        ["0x2b4d540735a4e128fda896f988415910a45cab41", "key"],
      );
  ...
  test(
    ...
    async () => {
      ...
      const rawTxn = await builder.build(
        ...
        ["0x2b4d540735a4e128fda896f988415910a45cab41", "key", "[hello,world]"],
      );
