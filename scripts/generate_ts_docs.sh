...
# This script helps you regenerate the TS docs at https://github.com/MoveupLabs/ts-sdk-doc.
...
git clone git@github.com:MoveupLabs/ts-sdk-doc.git $DOCS_DIR
...
echo 'Generated from `ecosystem/typescript/sdk/` in [moveup](https://github.com/MoveupLabs/moveup/tree/main/ecosystem/typescript/sdk) using `pnpm generate-ts-docs`.' >> $DOCS_DIR/README.md
