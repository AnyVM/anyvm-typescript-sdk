...
import { MoveupClient, MoveupAccount, CoinClient, FaucetClient } from "@anyvm/moveup-sdk";
...
(async () => {
  ...
  const bob = new MoveupAccount(); // <:!:section_2
  ...
  // Fund accounts.
  // :!:>section_3
  await faucetClient.fundAccount(alice.address(), 100_000_000_000_000_000);
  ...
  // Have Alice send Bob some more ETHs.
