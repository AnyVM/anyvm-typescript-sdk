...
(async () => {
  ...
  // ===========================================================================================
  const recipient = new MoveupAccount();
  ...
  let accountResource = await client.getAccountResource(recipient.address(), moveupCoinStore);
  ...
  accountResource = await client.getAccountResource(recipient.address(), moveupCoinStore);
  ...
  // ===========================================================================================
  const owner_4 = new MoveupAccount();
...
const rejectAndApprove = async (
  client: MoveupClient,
  owner1: MoveupAccount,
  owner2: MoveupAccount,
...
const getNumberOfOwners = async (client: MoveupClient, multisigAddress: string): Promise<number> => {
...
const getSignatureThreshold = async (client: MoveupClient, multisigAddress: string): Promise<number> => {
  const multisigAccountResource = await client.getAccountResource(
    multisigAddress,
    "0x1::multisig_account::MultisigAccount",
  );
